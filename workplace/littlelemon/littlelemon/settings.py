...
# The settings for static files have been updated for the Graded assessmen
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    BASE_DIR / "restaurant/static",  # App-specific static folder
]

# Ensure the collectstatic command works for production
